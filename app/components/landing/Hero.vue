...
<template>
  <UPageHero orientation='horizontal' :ui="{
    ...
    title: 'text-shadow-md max-w-lg mx-auto italic font-serif text-lg',
    ...
    <template #links>
      ...
      <Motion :initial="{
        ...
        <img :src="global.picture?.light!" :alt="global.picture?.alt!" class="rounded-lg shadow-2xl ring ring-default" />
      </Motion>
